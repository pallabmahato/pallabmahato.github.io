...
6. Your free site will be available at `https://pallabmahato.github.io/YOUR-REPOSITORY/`.

For a personal homepage, name the repository `pallabmahato.github.io`. Then the site will be available at:

```text
https://pallabmahato.github.io/
```
